              ...
              >
                ...
                <div className="p-4 flex flex-col flex-grow">
                  ...
                  {/* <button
                    ...
                    className="w-full py-2 border border-blue-600 text-blue-600 text-[10px] font-black uppercase tracking-widest hover:bg-blue-50 transition-colors"
                  >
                    View Details
                  </button> */}
                  ...
                  <Link
                    to={`/package/${pkg.id}`}
                    className="w-full py-2 border border-blue-600 text-blue-600 text-[10px] font-black uppercase tracking-widest hover:bg-blue-50 transition-colors flex items-center justify-center gap-1.5"
                  >
                    View Details
                   ...
                   <button
                    onClick={() => setEnquiry(pkg)}
                    className="w-full py-3 bg-blue-600 text-white text-[10px] font-black uppercase tracking-widest hover:bg-blue-700 transition-colors flex items-center justify-center gap-2 group/btn"
                  >
                    Enquire Now
                    <svg className="w-3.5 h-3.5 transition-transform group-hover/btn:translate-x-1"
