...
// // Add at top of ContactUs component
...
//                 type="text"
//                 className="bg-transparent border-b-2 border-slate-200 py-2 text-sm outline-none focus:border-blue-600 transition-all font-bold uppercase"
...
//                 rows="2"
//                 className="md:col-span-2 bg-transparent border-b-2 border-slate-200 py-2 text-sm outline-none focus:border-blue-600 transition-all font-bold resize-none uppercase"
...
//                 className="md:col-span-2 bg-blue-600 hover:bg-slate-900 text-white font-black py-4 uppercase tracking-[0.3em] text-[10px] shadow-xl transition-all flex items-center justify-center gap-2 disabled:opacity-50"
//               >
//                 {quickStatus === 'loading' ? 'Sending...' : 'Send Request'} <Send size={14}/>
//               </button>

//               {quickStatus === 'success' && (
//                 <p className="md:col-span-2 text-green-600 text-xs font-bold uppercase tracking-widest text-center">
//                   Message received! We'll contact you shortly.
//                 </p>
//               )}
//               {quickStatus === 'error' && (
//                 <p className="md:col-span-2 text-red-600 text-xs font-bold uppercase tracking-widest text-center">
...
//                     <p className="text-[11px] font-black text-slate-800 uppercase italic mt-1">Ms. Sapna</p>
//                   </div>
//                   <a href="tel:+919791007710" className="text-[10px] font-black bg-slate-900 text-white px-3 py-1.5 hover:bg-blue-600 transition-colors tracking-tighter">+91 97910 07710</a>
//                 </div>
//               </div>
//             </div>
//           </div>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 mt-12 relative z-30 pb-16">
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <motion.div
            ...
            className="lg:col-span-7 bg-white p-6 md:p-8 shadow-xl border-t-8 border-blue-600"
          >
            <h2 className="text-3xl font-black text-slate-900 uppercase tracking-tighter italic mb-6">
              Quick <span className="text-blue-600">Enquiry</span>
            </h2>
        ...
        <div className="mt-20 relative scroll-wrapper overflow-hidden">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-black uppercase italic tracking-tighter">
              Regional <span className="text-blue-600">Network</span>
            </h2>
            <div className="h-1.5 w-16 bg-blue-600 mx-auto mt-2"></div>
          </div>
          
          <button onClick={() => handleManualScroll('left')} className="absolute left-0 top-[60%] -translate-y-1/2 z-50 bg-white/90 p-2 shadow-lg border border-slate-100 text-blue-600 hover:bg-blue-600 hover:text-white transition-all rounded-full hidden md:block">
            <ChevronLeft size={32} />
          </button>
          <button onClick={() => handleManualScroll('right')} className="absolute right-0 top-[60%] -translate-y-1/2 z-50 bg-white/90 p-2 shadow-lg border border-slate-100 text-blue-600 hover:bg-blue-600 hover:text-white transition-all rounded-full hidden md:block">
          ...
          <div ref={scrollRef} className="relative flex overflow-x-hidden no-scrollbar">
            <div className="scroll-container py-10">
              {scrollBranches.map((branch, idx) => (
                <div key={idx} onClick={() => setSelectedBranch(branch)}
                  className="flex flex-col items-center text-center h-full mx-5 w-[280px] md:w-[320px] shrink-0">
                  <div className="w-full aspect-[5/4] overflow-hidden border-[6px] border-white shadow-sm ring-1 ring-gray-100 mb-6 cursor-pointer group">
                    <img src={branch.image} alt={branch.city} className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
                  </div>
                  <h2 className="text-slate-800 font-bold text-lg uppercase tracking-[0.2em] mb-4">{branch.city}</h2>
          ...
          >
            ...
            >
              <button onClick={() => setSelectedBranch(null)}
                className="absolute top-2 right-2 md:top-4 md:right-4 z-[110] bg-white md:bg-slate-100 p-2 hover:bg-blue-600 hover:text-white transition-colors shadow-md rounded-full">
                <X size={20}/>
              </button>
              <div className="grid md:grid-cols-2 items-stretch min-h-0 md:min-h-[550px]">
                <div className="h-56 md:h-full bg-slate-900 relative">
                ...
                <div className="p-6 md:p-10 space-y-6 md:space-y-8 flex flex-col justify-center bg-white">
                  <div className="flex flex-col md:flex-row justify-between items-start gap-4">
                    ...
                    <button onClick={() => navigate('/enquery')}
